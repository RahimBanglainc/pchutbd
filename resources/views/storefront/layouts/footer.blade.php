...
<script src="{{asset('assets/storefront/js/tiny-slider.js')}}"></script>
...
<div class="row footer">
    <div class="container">
        <div class="row">
            ...
            <div class="three columns m-top">
                <div><a href="#"><img src="./assets/storefront/img/bdstall-logo.png" width="30%"></a>
                </div>
            ...
            <div class="three columns m-top">
                ...
                <div><img src="./assets/storefront/img/google_play_icon.png"></div>

                <div class="s-top"><label>Follow us</label></div>

                <div class="social">
                    <a href="https://www.facebook.com/" target="_BLANK"><img src="./assets/storefront/img/fb_icon.png"></a>
                    {{-- <a href="https://twitter.com/bdstall" target="_BLANK"><img src="#asset/static-image/twitter_icon.png"></a> --}}
                    <a href="https://www.instagram.com/" target="_BLANK"><img
                            src="./assets/storefront/img/instagram_icon.png"></a>
                    <a href="https://www.youtube.com/" target="_BLANK"><img
                            src="./assets/storefront/img/youtube_icon.png"></a>
                    <a href="https://www.pinterest.com/" target="_BLANK"><img
                            src="./assets/storefront/img/pinterest_icon.png"></a>
                </div>
    ...
    <script src="{{asset('assets/storefront/js/jquery-1.2.pack.js')}}" integrity="sha256-Jlj95HpIFgrhbOHaU8Q6ziim4lqaMuyGN/TCiwnjLRc=" crossorigin="anonymous"></script>
    <script>
        http = getHTTPObject();
