...
<head>
    ...
    <link href="{{asset('assets/storefront/css/r-com-min-v56.css')}}" rel="stylesheet" type="text/css">
...
<body data-gr-c-s-loaded="true">
    ...
    <div class="main-header">
        <div class="container">
            ...
            <a href="#"><img src="./assets/storefront/img/bdstall-logo.png" alt="bdstall.com"
                    title="bdstall.com"></a>
            ...
            <a href="##search_box" class="search-btn" id="search"><img
                    src="./assets/site-search-icon.png"></a>
