        ...
        <div class="card">
            <div class="card-body">
                <div class="dropdown float-right">
                    <a href="{{route('admin.page.create')}}" class="btn btn-success mb-2"><i class="mdi mdi-plus mr-2"></i> Add Page</a>
                </div>

                <h4 class="card-title mb-4">All Pages</h4>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="{{ route('page.view', $page->slug) }}">
                                        {{ \Illuminate\Support\Str::limit($page->name, 30) }}

                                    </a>
                                </td>
                                <td>
                                    {!! \Illuminate\Support\str::limit(strip_tags($page->slug), 50) !!}
                                ...
                                <td>
                                    <div class="badge badge-soft-warning font-size-12">{{ $page->views}}</div>
                                </td>
                                <td>
                                    <a href="{{route('admin.page.edit', $page->id)}}" class="mr-3 text-primary" data-toggle="tooltip"
                                        data-placement="top" title="" data-original-title="Edit"><i
                                            class="mdi mdi-pencil font-size-18"></i></a>

                                    <a class="text-danger" data-toggle="tooltip"
                                        data-placement="top" title="" data-original-title="Delete"  onclick="blogDelete({{ $page->id }})"><i
                                            class="mdi mdi-trash-can font-size-18"></i>
                                    </a>
                                        <form method="POST" style="display: none;" action="{{route('admin.page.destroy', $page->id)}}" id="delete-form-{{$page->id}}">
                                            @csrf
