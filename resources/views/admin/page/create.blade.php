    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card-body">
                ...
                <div>
                    <div class="mb-4">
                        <input class="form-control" type="text" name="name" placeholder="Page Title" required>
                    </div>

                    <div class="mb-4">
                        <input class="form-control" type="text" name="slug" placeholder="Page Slug/URL" required>
                    </div>
