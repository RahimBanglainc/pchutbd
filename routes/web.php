...
Route::get('category/brand/{slug}', 'HomeController@brandCategory')->name('brandcat.view');
Route::get('category/brand/item/{slug}', 'HomeController@subcategory')->name('catitem.view');
